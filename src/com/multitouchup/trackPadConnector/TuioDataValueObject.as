/*
	Original code from the org.tuio project located at:
						http://bubblebird.at/tuioflash/

	org.tuio.TuioContainer was written by @author Immanuel Bauer


*/
package com.multitouchup.trackPadConnector
{
	public class TuioDataValueObject
	{
		...
		public function TuioDataValueObject(type:String, sID:Number, x:Number, y:Number, z:Number, X:Number, Y:Number, Z:Number, m:Number, frameID:uint) {
			this._type = type;
			this._sessionID = sID;
			this._x = x;
			this._y = y;
